...
from utils.handy_CONTAINABLE import write_pddl
...
if __name__ == '__main__':
    ...
    if (arr_rgb.shape[0] > 100 and arr_rgb.shape[1] > 100):
        ...
        subprocess.call('~/fast-downward/fast-downward.py ../pddl/domain_CONTAINABLE.pddl ../pddl/auto_problem_CONTAINABLE.pddl --search "astar(blind())"', shell=True)
