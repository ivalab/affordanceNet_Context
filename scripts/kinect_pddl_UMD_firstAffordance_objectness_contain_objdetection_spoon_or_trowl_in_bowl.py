...
from utils.handy_SCOOPBEANS import write_pddl
...
if __name__ == '__main__':
    ...
    if (arr_rgb.shape[0] > 100 and arr_rgb.shape[1] > 100):
        ...
        subprocess.call('~/fast-downward/fast-downward.py ../pddl/domain_SCOOPBEANS.pddl ../pddl/auto_problem_SCOOPBEANS.pddl --search "astar(blind())"', shell=True)
        ...
        for arg, obj in enumerate(action[1:]):
            ...
            # If the action is scoop, select desired object centroid based on contains (1)
                ...
                if arg == 0:
                    ...
                    obj_pose_3D = Pose()
                    obj_pose_3D.position.x = round(coords_3D_max_grasp[0], 2) + 0.30
                    obj_pose_3D.position.y = round(coords_3D_max_grasp[1], 2) + 0.32
                    obj_pose_3D.position.z = round(coords_3D_max_grasp[2], 2) - 0.0178 - 0.045
                    ...
                    obj_pose_3D = Pose()
                    obj_pose_3D.position.x = round(coords_3D_max_scoop[0], 2) + 0.30
                    obj_pose_3D.position.y = round(coords_3D_max_scoop[1], 2) + 0.32
                    obj_pose_3D.position.z = round(coords_3D_max_scoop[2], 2) - 0.0178 - 0.045
                    obj_pose_3D.orientation.x = 0
                    obj_pose_3D.orientation.y = 0
                    obj_pose_3D.orientation.z = 0
                    obj_pose_3D.orientation.w = angle
                ...
                if arg == 1:
                    ...
                    if offset and offset_max:
                        ...
                        coords_3D[1], coords_3D_max[1] = coords_3D[1], coords_3D_max[1]
                    angle = 0
